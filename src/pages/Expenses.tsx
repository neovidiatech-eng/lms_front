...
const [showModal, setShowModal] = useState(false);
  ...
  const text = {
    ...
    confirmDelete: { ar: 'هل أنت متأكد من حذف هذا المصروف؟', en: 'Are you sure you want to delete this expense?' },
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="text-right">
              <p className="text-sm text-gray-600 mb-1">{text.totalExpenses[language]}</p>
              <h2 className="text-4xl font-bold text-red-600">{totalAmount.toFixed(2)}</h2>
              <p className="text-sm text-gray-500 mt-1">{filteredExpenses.length} {text.totalCount[language]}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full" dir="rtl">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-6 py-4 text-right text-sm font-semibold text-gray-900">{text.description[language]}</th>
                  <th className="px-6 py-4 text-right text-sm font-semibold text-gray-900">{text.category[language]}</th>
                  <th className="px-6 py-4 text-right text-sm font-semibold text-gray-900">{text.amount[language]}</th>
                  <th className="px-6 py-4 text-right text-sm font-semibold text-gray-900">{text.date[language]}</th>
                  <th className="px-6 py-4 text-right text-sm font-semibold text-gray-900">{text.paymentMethod[language]}</th>
                  <th className="px-6 py-4 text-right text-sm font-semibold text-gray-900">{text.status[language]}</th>
                  <th className="px-6 py-4 text-right text-sm font-semibold text-gray-900">{text.actions[language]}</th>
                </tr>
              </thead>
