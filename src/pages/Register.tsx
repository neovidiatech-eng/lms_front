...
import { Eye, EyeOff, Check, ChevronDown, ArrowLeft, ArrowRight } from 'lucide-react';
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="text-center text-gray-400 text-sm my-4">
            {language === 'ar' ? 'أو سجل باستخدام البريد الإلكتروني' : 'Or register with email'}
          </div>
              ...
              <div className="space-y-3">
                {packages.map((pkg) => (
                  <button
                    ...
                    className={`w-full p-4 rounded-xl border-2 transition-all text-right ${formData.selectedPackage === pkg.id
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className={`font-bold text-lg mb-1 ${formData.selectedPackage === pkg.id ? 'text-primary' : 'text-gray-900'
                          }`}>
                          {pkg.name}
                        </div>
                        <div className="text-gray-600 text-sm">
                          {pkg.sessions} {language === 'ar' ? 'حصة' : 'sessions'} • {pkg.currency} {pkg.price.toFixed(2)}
                        </div>
                        {pkg.description && (
