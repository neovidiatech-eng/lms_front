    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">إدارة جميع الكورسات والمحتوى التعليمي</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {[
          { label: 'إجمالي الكورسات', value: courses.length, color: 'bg-primary-light text-primary', icon: BookOpen },
          { label: 'عدد المستويات', value: levels.length, color: 'bg-green-50 text-green-600', icon: Layers },
        ].map((s, i) => (
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-500">{filtered.length} كورس</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                <th className="text-right px-4 py-3 text-xs font-semibold text-gray-600">الكورس</th>
                <th className="text-right px-4 py-3 text-xs font-semibold text-gray-600">المادة</th>
                <th className="text-right px-4 py-3 text-xs font-semibold text-gray-600">المستوى</th>
                <th className="text-right px-4 py-3 text-xs font-semibold text-gray-600">ملفات</th>
                <th className="text-right px-4 py-3 text-xs font-semibold text-gray-600">إجراءات</th>
              </tr>
            </thead>
              ...
              {filtered.map(course => {
                ...
                return (
                  <tr key={course.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className="text-xs text-gray-500">{course.attachments.length} ملف</span>
                    </td>
                    <td className="px-4 py-3">
